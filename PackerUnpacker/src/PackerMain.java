...
class PackerMain
{
    public static void main(String arg[])
    {
        try
        {
            PackerLogin frame = new PackerLogin();
...
class PackerLogin extends Template implements ActionListener, Runnable {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == SUBMIT) {
            if (Validate(value1, value2) == false) {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, "Short username", "Packer Unpacker",
                        JOptionPane.ERROR_MESSAGE);
            }
            if (value1.equals("PackerAdmin") && value2.equals("PackerAdmin")) {
                ...
                if (attemp == 0) {
                    JOptionPane.showMessageDialog(this, "Number of attempts finished", "Packer Unpacker",
                            JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
